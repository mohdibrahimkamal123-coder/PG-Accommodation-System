...
const OwnerRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await ownerRegister(ownerData);
            setMessage(response?.data || "Owner Account created successfully! Redirecting to login...");
    ...
    return (
        <div style={styles.wrapper}>
            ...
            <div style={styles.card}>
                ...
                {/* Bottom Left Isometric SVG Accent */}
                ...
                {/* Custom Header Art Illustration */}
                <div style={styles.header}>
                    ...
                    <h1 style={styles.headline}>Create Owner Account</h1>
                    <p style={styles.subheadline}>Register your account to manage and list your PG properties.</p>
                </div>
                ...
                <div style={styles.footerBox}>
                    ...
                    <Link to="/owner/login" style={styles.signupLink}>
                        Owner Sign In
                    </Link>
                </div>
            </div>

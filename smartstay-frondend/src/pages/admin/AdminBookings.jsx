...
const AdminBookings = () => {
    ...
    const filteredBookings = bookings.filter(booking => {
        const searchMatch = 
            ...
            booking.bookingNumber?.toString().includes(search) ||
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                            ...
                            <tbody>
                                {filteredBookings.map((booking) => {
                                    ...
                                    return (
                                        <tr key={booking.bookingId || booking.id} style={{ transition: 'all 0.2s ease' }} onMouseEnter={(e) => e.currentTarget.style.background = '#f8fafc'} onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
                                            <td style={{ padding: '16px 12px', borderBottom: '1px solid #f8fafc', verticalAlign: 'middle', fontWeight: 700, color: '#0f172a', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                                #{booking.bookingNumber || booking.bookingId || booking.id}
                                            </td>
                                            <td style={{ padding: '16px 12px', borderBottom: '1px solid #f8fafc', verticalAlign: 'middle', fontWeight: 600, color: '#0f172a', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                            ...
                                            <td style={{ padding: '16px 12px', borderBottom: '1px solid #f8fafc', verticalAlign: 'middle', color: '#475569', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                                {booking.moveInDate || booking.checkIn || 'N/A'}
                                            </td>
                                            <td style={{ padding: '16px 12px', borderBottom: '1px solid #f8fafc', verticalAlign: 'middle', color: '#475569', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                                {booking.expectedStayMonths || 'N/A'}
                                            </td>
